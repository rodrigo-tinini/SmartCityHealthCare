...
class FacilitiesControllerTest < ActionController::TestCase
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post :create, facility: { address: @facility.address, classOf: @facility.classOf, lat: @facility.lat, longi: @facility.longi, type: @facility.type }
    end
  ...
  test "should update facility" do
    patch :update, id: @facility, facility: { address: @facility.address, classOf: @facility.classOf, lat: @facility.lat, longi: @facility.longi, type: @facility.type }
    assert_redirected_to facility_path(assigns(:facility))
  end
